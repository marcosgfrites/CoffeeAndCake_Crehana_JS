/* Para autoproteger el código se crea una función autoejecutable.
Se protege el código, variables y métodos para que otro script no pueda acceder
a todos nuestros datos privados. La forma de sintaxis es "(function(){//cuerpo de la función}())"
*/
